                    ...
                    <div class="col-md-10">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{url('createEvent')}}" method="POST" enctype="multipart/form-data" id="eventForm" novalidate >
                                    @csrf
                                    <div class="row">

                                        <div class="col-md-4">
                                            <label for="EventImagePath">Image</label>
                                            <input type="file" class="form-control-file" id="EventImagePath" name='EventImagePath'
                                                value="{{ old('EventImagePath') }}">
                                        </div>
                                        <div class=" col-md-6">
                                            <label for="EventTitle">Event Title *</label>

                                            <input type="text" id="EventTitle" class="form-control" name="EventTitle"
                                                required autofocus value="{{ old('EventTitle') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class=" form-group row">
                                        <div class="col-md-6 offset-md-4">
                                            ...
                                            <textarea class="form-control animated" id="EventDescription"
                                                ...
                                                visibility="visible">{{ old('EventDescription') }}</textarea>
                                            ...
                                            <div class="form-group">
                                                <div class='input-group date' id='EventStartTime'>
                                                    <input type='text' class="form-control" name='EventStartTime'
                                                        minlength="3" value="{{ old('EventStartTime') }}" />
